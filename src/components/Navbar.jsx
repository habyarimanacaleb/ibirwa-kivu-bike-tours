    ...
    <>
      ...
      <nav className="bg-black h-20 fixed w-full top-0 left-0 z-50 shadow-md px-2 items-center justify-center">
        <div className="container mx-auto flex justify-between items-center py-4 ">
          ...
          <ul
            className={`md:flex md:space-x-6 absolute md:static md:items-center font-semibold text-[17px] px-6  sm:bg-black md:bg-black md:w-auto w-full left-0 top-20 transition-all duration-500 ease-in-out ${isOpen

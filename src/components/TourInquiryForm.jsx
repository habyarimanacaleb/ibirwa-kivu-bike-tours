...
const TourInquiryForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://demo.ibirwakivubiketours.com/api/inquiries",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="text-white py-1 px-5 md:px-20 mt-[-20%] lg:mt-[-5%] mb-20 z-10">
      <div className="w-full lg:max-w-3xl mx-auto bg-gray-900 p-8 rounded-lg shadow-lg mb-2">

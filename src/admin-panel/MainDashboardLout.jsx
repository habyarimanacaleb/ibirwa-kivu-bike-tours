      ...
      async function fetchAnalytics() {
        try {
          const usersRes = await axios.get(
            "https://demo.ibirwakivubiketours.com/api/ibirwa-clients/users"
          );
          ...
          const galleryRes = await axios.get(
            "https://demo.ibirwakivubiketours.com/api/gallery"
          );
    ...
    const fetchData = async () => {
      try {
        const [servicesResponse, galleryResponse] = await Promise.all([
          axios.get("https://demo.ibirwakivubiketours.com/api/services"),
          axios.get("https://demo.ibirwakivubiketours.com/api/gallery"),
        ]);
